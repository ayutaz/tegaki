...
[![license](https://img.shields.io/npm/l/tegaki)](https://github.com/ayutaz/tegaki/blob/main/LICENSE)
...
For kanji or other fonts, use the [interactive generator](https://ayutaz.github.io/tegaki/generator/) to create a custom bundle (pass `--dataset kanjivg --rhythm lognormal` for authoritative Japanese output).
...
The bundle is 217 KB (97 KB subsetted Noto Sans JP + 120 KB stroke data). Kanji support is opt-in at generate time via `--dataset kanjivg` — see the [Japanese guide](https://ayutaz.github.io/tegaki/guides/japanese/) for coverage, license (CC-BY-SA 3.0 on the stroke data), and known limitations.

## Documentation

Visit **[ayutaz.github.io/tegaki](https://ayutaz.github.io/tegaki)** for full documentation:

- [Getting Started](https://ayutaz.github.io/tegaki/getting-started/)
- [Framework Guides](https://ayutaz.github.io/tegaki/frameworks/react/) (React, Svelte, Vue, SolidJS, Astro, Web Components, Vanilla)
- [Generating Fonts](https://ayutaz.github.io/tegaki/guides/generating/)
- [API Reference](https://ayutaz.github.io/tegaki/api/renderer/)
